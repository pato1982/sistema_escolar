        ...
        <div class="hero-image">
            <div class="hero-graphic">
                ...
                <div class="cube-container">
                    <div class="cube">
                        <div class="cube-face cube-front"><span class="cube-letra">E</span><span
                                class="cube-texto">Portal Estudiantil</span></div>
                        <div class="cube-face cube-back"><span class="cube-letra">E</span><span
                                class="cube-texto">Portal Estudiantil</span></div>
                        <div class="cube-face cube-right"><span class="cube-letra">E</span><span
                                class="cube-texto">Portal Estudiantil</span></div>
                        <div class="cube-face cube-left"><span class="cube-letra">E</span><span
                                class="cube-texto">Portal Estudiantil</span></div>
                        <div class="cube-face cube-top"><span class="cube-letra">E</span><span class="cube-texto">Portal
                                Estudiantil</span></div>
                        <div class="cube-face cube-bottom"><span class="cube-letra">E</span><span
                                class="cube-texto">Portal Estudiantil</span></div>
                    </div>
                </div>
    ...
    <section class="caracteristicas" id="caracteristicas">
        <div class="section-container">
            <div class="section-header">
                ...
                <p>Diseñada para facilitar la comunicación y el seguimiento académico entre todos los actores de la
        ...
        <div class="section-container">
            ...
            <div class="beneficios-grid">
                <div class="beneficio-item">
                    ...
                    <p>Utilice el portal desde su computador de escritorio, laptop, tablet o teléfono móvil. Siempre
                        disponible cuando lo necesite.</p>
                </div>
                <div class="beneficio-item">
                    <div class="beneficio-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none"
                    ...
                    <p>La información de cada usuario está protegida. Los apoderados solo acceden a los datos de sus
                        pupilos, garantizando la privacidad de todos.</p>
                </div>
                <div class="beneficio-item">
                    <div class="beneficio-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none"
                    ...
                    <p>Interfaz intuitiva diseñada para que cualquier persona pueda utilizarla sin complicaciones ni
                        necesidad de capacitación.</p>
                </div>
                <div class="beneficio-item">
                    <div class="beneficio-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none"
                    ...
                    <p>Las notas y comunicados se actualizan en tiempo real. Siempre tendrá acceso a la información más
                        reciente.</p>
                </div>
            </div>
        </div>
            ...
            <div class="footer-contacto">
                ...
                <div class="contacto-items">
                    <a href="mailto:contacto@portalestudiantil.cl" class="contacto-item">
                        <svg class="icon-email" xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                            viewBox="0 0 24 24" fill="none" stroke="#EA4335" stroke-width="2" stroke-linecap="round"
                    ...
                    <a href="https://wa.me/56912345678" target="_blank" class="contacto-item">
                        <svg class="icon-whatsapp" xmlns="http://www.w3.org/2000/svg" width="18" height="18"
    ...
    <div id="modalTerminos" class="modal-footer-overlay" onclick="cerrarModalTerminos(event)">
        <div class="modal-footer-contenido" onclick="event.stopPropagation()">
            ...
            <div class="modal-footer-body">
                ...
                <p>Al acceder y utilizar Portal Estudiantil, usted acepta estar sujeto a estos Términos y Condiciones de
                    Uso y todas las leyes y regulaciones aplicables. Usted acepta que es responsable del cumplimiento de
                    las leyes locales aplicables. Si no está de acuerdo con alguno de estos términos, tiene prohibido
                    usar o acceder a este sitio.</p>

                <h3>2. Definiciones</h3>
                <ul>
                    <li><strong>Plataforma:</strong> Sistema de Gestión Académica Portal Estudiantil.</li>
                    <li><strong>Usuario:</strong> Toda persona que acceda y utilice la plataforma, incluyendo
                        apoderados, docentes y administradores.</li>
                    <li><strong>Establecimiento:</strong> Institución educacional que utiliza los servicios de la
                        plataforma.</li>
                    <li><strong>Contenido:</strong> Toda información, datos, textos y materiales disponibles en la
                        plataforma.</li>
                </ul>
                ...
                <ul>
                    <li>Utilizar la plataforma únicamente para los fines educativos y administrativos para los que fue
                        diseñada.</li>
                ...
                <p>Para acceder a la plataforma, los usuarios deben registrarse proporcionando información personal
                    válida. El usuario es responsable de mantener la confidencialidad de su contraseña y de todas las
                    actividades que ocurran bajo su cuenta. Debe notificar inmediatamente cualquier uso no autorizado de
                    su cuenta.</p>

                <h3>5. Propiedad Intelectual</h3>
                <p>Todos los contenidos de la plataforma, incluyendo pero no limitado a textos, gráficos, logotipos,
                    iconos, imágenes, clips de audio, descargas digitales y compilaciones de datos, son propiedad de
                    Portal Estudiantil o sus proveedores de contenido y están protegidos por las leyes chilenas e
                    internacionales de propiedad intelectual, conforme a la <strong>Ley N° 17.336</strong> sobre
                    Propiedad Intelectual.</p>

                <h3>6. Protección de Datos</h3>
                <p>El tratamiento de datos personales se realiza conforme a nuestra Política de Privacidad y en
                    cumplimiento de la <strong>Ley N° 19.628</strong> sobre Protección de la Vida Privada y la
                    <strong>Ley N° 21.719</strong> que moderniza el marco de protección de datos personales en Chile.
                </p>
                ...
                <p>Portal Estudiantil se reserva el derecho de modificar, suspender o discontinuar, temporal o
                    permanentemente, el servicio o cualquier parte del mismo, con o sin previo aviso. No seremos
                    responsables ante usted ni ante terceros por cualquier modificación, suspensión o interrupción del
                    servicio.</p>

                <h3>10. Modificaciones de los Términos</h3>
                <p>Nos reservamos el derecho de actualizar estos Términos y Condiciones en cualquier momento. Cuando se
                    realicen modificaciones, los usuarios serán notificados a través de la plataforma o mediante correo
                    electrónico. Las modificaciones entrarán en vigor a partir de su publicación. El uso continuado de
                    la plataforma después de recibir dicha notificación se entenderá como la aceptación de los nuevos
                    términos por parte del usuario.</p>

                <h3>11. Legislación Aplicable</h3>
                <p>Estos Términos y Condiciones se regirán e interpretarán de acuerdo con las leyes de la República de
                    Chile. Cualquier disputa que surja en relación con estos términos será sometida a la jurisdicción de
                    los tribunales ordinarios de justicia de Chile.</p>
    ...
    <div id="modalPrivacidad" class="modal-footer-overlay" onclick="cerrarModalPrivacidad(event)">
        <div class="modal-footer-contenido" onclick="event.stopPropagation()">
            ...
            <div class="modal-footer-body">
                ...
                <p>En Portal Estudiantil nos comprometemos a proteger la privacidad y los datos personales de nuestros
                    usuarios. Esta política de privacidad describe cómo recopilamos, utilizamos, almacenamos y
                    protegemos su información personal, en cumplimiento con la legislación chilena vigente.</p>

                <h3>2. Marco Legal Aplicable</h3>
                <p>Nuestra política de privacidad se rige por las siguientes normativas chilenas:</p>
                <ul>
                    <li><strong>Ley N° 19.628</strong> sobre Protección de la Vida Privada (Ley de Protección de Datos
                        Personales), que regula el tratamiento de datos personales en registros o bancos de datos.</li>
                    <li><strong>Ley N° 21.096</strong> que consagra el derecho a la protección de datos personales como
                        garantía constitucional.</li>
                    <li><strong>Ley N° 21.719</strong> (Nueva Ley de Protección de Datos Personales) que moderniza el
                        marco regulatorio estableciendo nuevos estándares de protección.</li>
                    <li><strong>Ley N° 20.584</strong> sobre derechos y deberes de las personas en relación con acciones
                        vinculadas a su atención de salud, en lo aplicable a datos sensibles.</li>
                </ul>

                <h3>3. Datos que Recopilamos</h3>
                <p>Recopilamos los siguientes tipos de datos personales:</p>
                <ul>
                    <li><strong>Datos de identificación:</strong> nombre completo, RUT, dirección, teléfono y correo
                        electrónico.</li>
                    <li><strong>Datos académicos:</strong> calificaciones, asistencia, observaciones pedagógicas y
                        reportes de rendimiento.</li>
                ...
                <ul>
                    ...
                    <li><strong>Oposición:</strong> oponerse al tratamiento de sus datos en determinadas circunstancias.
                    </li>
                ...
                <p>Implementamos medidas técnicas y organizativas apropiadas para proteger sus datos personales contra
                    el acceso no autorizado, la alteración, divulgación o destrucción. Estas medidas incluyen
                    encriptación de datos, accesos restringidos y protocolos de seguridad actualizados.</p>

                <h3>7. Conservación de Datos</h3>
                <p>Los datos personales serán conservados durante el tiempo necesario para cumplir con las finalidades
                    descritas y conforme a los plazos establecidos por la normativa educacional chilena.</p>

                <h3>8. Contacto</h3>
                <p>Para ejercer sus derechos o realizar consultas sobre esta política de privacidad, puede contactarnos
                    a través de nuestros canales oficiales: <strong>contacto@portalestudiantil.cl</strong></p>
            </div>
            <div class="modal-footer-pie">
                <p>Última actualización: Noviembre 2024 | Portal Estudiantil - Sistema de Gestión Académica</p>
            </div>
