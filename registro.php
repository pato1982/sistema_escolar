                ...
                <div class="registro-card">
                    ...
                    <div id="paso-1" class="paso-contenido">
                        <div class="paso-header">
                            ...
                            <button type="button" class="btn btn-sm btn-secondary" onclick="completarPaso1()">Completar
                                con ejemplo</button>
                        </div>
                        <form id="formPaso1">
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="rutApoderado" class="form-control"
                                        placeholder="Ej: 12.345.678-9" required>
                                </div>
                                <div class="form-group">
                                    <label for="telefonoApoderado">Teléfono</label>
                                    <input type="tel" id="telefonoApoderado" class="form-control"
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="email" id="correoApoderado" class="form-control"
                                        placeholder="Ej: correo@ejemplo.com" required>
                                </div>
                                <div class="form-group">
                                    <label for="confirmarCorreoApoderado">Confirmar Correo</label>
                                    <input type="email" id="confirmarCorreoApoderado" class="form-control"
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="direccionApoderado" class="form-control"
                            ...
                            <div class="form-row form-row-single">
                                <div class="form-group form-group-full">
                                    <label for="establecimientoApoderado"><span class="label-full">Establecimiento
                                            Educativo</span><span class="label-short">Establecimiento</span></label>
                    ...
                    <div id="paso-2" class="paso-contenido">
                        <div class="paso-header">
                            ...
                            <button type="button" class="btn btn-sm btn-secondary" onclick="completarPaso2()">Completar
                                con ejemplo</button>
                        </div>
                        <form id="formPaso2">
                                ...
                                <div class="alumno-card" data-alumno="1">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="nombreAlumno_1" class="form-control"
                                                placeholder="Ej: Juan Pablo" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="apellidoAlumno_1">Apellidos del Alumno</label>
                                            <input type="text" id="apellidoAlumno_1" class="form-control"
                                                placeholder="Ej: González Muñoz" required>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group">
                                            <label for="rutAlumno_1">RUT del Alumno</label>
                                            <input type="text" id="rutAlumno_1" class="form-control"
                                                placeholder="Ej: 23.456.789-0" required>
                                        </div>
                                        <div class="form-group">
                        ...
                        <form id="formPaso3">
                            <div class="form-row">
                                <div class="form-group">
                                    <label for="password">
                                        Contraseña
                                        <span class="tooltip-trigger" onclick="toggleTooltip(event)"
                                            onmouseenter="showTooltip(this)" onmouseleave="hideTooltip(this)">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                viewBox="0 0 24 24" fill="#f59e0b" stroke="#f59e0b" stroke-width="2">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <text x="12" y="17" text-anchor="middle" fill="white" stroke="none"
                                                    font-size="14" font-weight="bold">?</text>
                                            </svg>
                                            <span class="tooltip-content">La contraseña debe tener exactamente 8 dígitos
                                                numéricos. No se permiten letras, signos, comas ni puntos.</span>
                                        </span>
                                    </label>
                                    <input type="password" id="password" class="form-control" placeholder="Ej: 12345678"
                                        required>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="form-actions">
                                ...
                                <button type="button" class="btn btn-primary" onclick="finalizarRegistro()">Finalizar
                                    Registro</button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div id="paso-final" class="paso-contenido">
                        <div class="registro-exitoso">
                            ...
                            <button type="button" class="btn btn-primary" onclick="window.location.href='login.php'">Ir
                                al Sistema</button>
                        </div>
                    </div>
                    ...
                    <div id="paso-docente-1" class="paso-contenido">
                        <div class="paso-header">
                            ...
                            <button type="button" class="btn btn-sm btn-secondary"
                                onclick="completarPasoDocente1()">Completar con ejemplo</button>
                        </div>
                        <form id="formPasoDocente1">
                            <div class="form-row">
                                <div class="form-group">
                                    <label for="nombreDocente">Nombres</label>
                                    <input type="text" id="nombreDocente" class="form-control"
                                        placeholder="Ej: Carlos Alberto" required>
                                </div>
                                <div class="form-group">
                                    <label for="apellidoDocente">Apellidos</label>
                                    <input type="text" id="apellidoDocente" class="form-control"
                                        placeholder="Ej: Martínez López" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group">
                                    <label for="rutDocente">RUT</label>
                                    <input type="text" id="rutDocente" class="form-control"
                                        placeholder="Ej: 12.345.678-9" required>
                                </div>
                                <div class="form-group">
                                    <label for="telefonoDocente">Teléfono</label>
                                    <input type="tel" id="telefonoDocente" class="form-control"
                                        placeholder="Ej: +56 9 1234 5678" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="email" id="correoDocente" class="form-control"
                                        placeholder="Ej: correo@ejemplo.com" required>
                                </div>
                                <div class="form-group">
                                    <label for="confirmarCorreoDocente">Confirmar Correo</label>
                                    <input type="email" id="confirmarCorreoDocente" class="form-control"
                                        placeholder="Repetir correo electrónico" required>
                                </div>
                            </div>
                            <div class="form-row form-row-single">
                                <div class="form-group form-group-full">
                                    <label for="establecimientoDocente"><span class="label-full">Establecimiento
                                            Educativo</span><span class="label-short">Establecimiento</span></label>
                            ...
                            <div class="form-actions">
                                <button type="button" class="btn btn-secondary"
                                    onclick="volverATipoDocente()">Volver</button>
                                <button type="button" class="btn btn-primary"
                                    onclick="irAPasoDocente2()">Siguiente</button>
                            </div>
                        </form>
                    </div>
                        ...
                        <form id="formPasoDocente2">
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="password" id="passwordDocente" class="form-control"
                                        placeholder="Ej: 12345678" required>
                                </div>
                                <div class="form-group">
                                    <label for="confirmarPasswordDocente">Repetir Contraseña</label>
                                    <input type="password" id="confirmarPasswordDocente" class="form-control"
                                        placeholder="Ej: 12345678" required>
                                </div>
                            </div>
                            <div class="form-actions">
                                <button type="button" class="btn btn-secondary"
                                    onclick="volverAPasoDocente1()">Volver</button>
                                <button type="button" class="btn btn-primary"
                                    onclick="finalizarRegistroDocente()">Finalizar Registro</button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div id="paso-admin-1" class="paso-contenido">
                        <div class="paso-header">
                            ...
                            <button type="button" class="btn btn-sm btn-secondary"
                                onclick="completarPasoAdmin1()">Completar con ejemplo</button>
                        </div>
                        <form id="formPasoAdmin1">
                            <div class="form-row">
                                <div class="form-group">
                                    <label for="nombreAdmin">Nombres</label>
                                    <input type="text" id="nombreAdmin" class="form-control"
                                        placeholder="Ej: María Elena" required>
                                </div>
                                <div class="form-group">
                                    <label for="apellidoAdmin">Apellidos</label>
                                    <input type="text" id="apellidoAdmin" class="form-control"
                                        placeholder="Ej: Rodríguez Soto" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group">
                                    <label for="rutAdmin">RUT</label>
                                    <input type="text" id="rutAdmin" class="form-control" placeholder="Ej: 12.345.678-9"
                                        required>
                                </div>
                                <div class="form-group">
                                    <label for="telefonoAdmin">Teléfono</label>
                                    <input type="tel" id="telefonoAdmin" class="form-control"
                                        placeholder="Ej: +56 9 1234 5678" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="email" id="correoAdmin" class="form-control"
                                        placeholder="Ej: correo@ejemplo.com" required>
                                </div>
                                <div class="form-group">
                                    <label for="confirmarCorreoAdmin">Confirmar Correo</label>
                                    <input type="email" id="confirmarCorreoAdmin" class="form-control"
                                        placeholder="Repetir correo electrónico" required>
                                </div>
                            </div>
                            <div class="form-row form-row-single">
                                <div class="form-group form-group-full">
                                    <label for="establecimientoAdmin"><span class="label-full">Establecimiento
                                            Educativo</span><span class="label-short">Establecimiento</span></label>
                            ...
                            <div class="form-actions">
                                <button type="button" class="btn btn-secondary"
                                    onclick="volverATipoAdmin()">Volver</button>
                                <button type="button" class="btn btn-primary"
                                    onclick="irAPasoAdmin2()">Siguiente</button>
                            </div>
                        </form>
                    </div>
                        ...
                        <form id="formPasoAdmin2">
                            <div class="form-row form-row-single">
                                <div class="form-group form-group-full">
                                    ...
                                    <input type="text" id="codigoValidacionAdmin" class="form-control"
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" id="confirmarPasswordAdmin" class="form-control"
                                        placeholder="Ej: 12345678" required>
                                </div>
                            </div>
                            <div class="form-actions">
                                <button type="button" class="btn btn-secondary"
                                    onclick="volverAPasoAdmin1()">Volver</button>
                                <button type="button" class="btn btn-primary"
                                    onclick="finalizarRegistroAdmin()">Finalizar Registro</button>
                            </div>
                        </form>
                    </div>
                </div>
